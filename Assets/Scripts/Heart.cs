...
public class Heart : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int i =0; i < numSphere; i++){
            ...
            float theta = i * 2f * Mathf.PI / numSphere;

            float k = 4f;    
            float radius = r * Mathf.Cos(k * theta);

            endPosition[i] = new Vector3(
                radius * Mathf.Cos(theta),
                radius * Mathf.Sin(theta),
                10f + Mathf.Sin(time + i * 0.5f) * 0.3f   
            );
            ...
            // endPosition[i] = new Vector3 (
            //     r * (Mathf.Sqrt(2f) * sin * sin * sin),
            //     r * (-1 * cos * cos * cos - cos * cos + 2 * cos),  
            //     10f + Mathf.Sin(time * i) * 0.2f);
            //-------------------------------------------------
            ...
            //Color color = Color.HSVToRGB(control, 1f, 1f);
